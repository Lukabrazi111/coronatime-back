    <form wire:submit.prevent='store' action="#" method="post" class="flex flex-col w-full mt-2 md:w-6/12">
        ...
        <div class="flex flex-col relative">
            ...
            <input wire:model='password'
                class="px-4 py-4 rounded-lg border @if ($password) @error('password') border-red-600 @else border-green-600 @enderror @else border-gray-200 @endif mb-2 placeholder-dark" type="password"
